...
function attachRemoteTrack(track, targetUserId) {
...
function detachRemoteTrack(targetUserId) {
...
function updateAudioLevelUI(level) {
    ...
    if (audioLevelIndicator) {
        ...
        if (percentage < 20) {
            audioLevelIndicator.style.background = '#72767d';
        } else if (percentage < 50) {
            audioLevelIndicator.style.background = '#43b581';
        } else if (percentage < 80) {
            audioLevelIndicator.style.background = '#faa61a';
        } else {
            audioLevelIndicator.style.background = '#f04747';
        }
    }
}
...
function cleanupAudioMonitoring() {
    ...
    if (audioContextResumeInterval) clearInterval(audioContextResumeInterval);
